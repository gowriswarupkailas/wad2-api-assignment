...
/*!*********************************************************************************************************!*\
  !*** ./node_modules/@storybook/components/dist/esm/syntaxhighlighter/syntaxhighlighter.js + 17 modules ***!
  \*********************************************************************************************************/
...
// CONCATENATED MODULE: ./node_modules/@storybook/components/dist/esm/ActionBar/ActionBar.js
...
var Container = dist_esm["styled"].div(function (_ref) {
...
var ActionButton = dist_esm["styled"].button(function (_ref2) {
...
var ActionBar_ActionBar = function ActionBar(_ref4) {
  var actionItems = _ref4.actionItems,
      props = _objectWithoutProperties(_ref4, ["actionItems"]);

  return /*#__PURE__*/react_default.a.createElement(Container, props, actionItems.map(function (_ref5, index) {
    ...
    return (
      ...
      react_default.a.createElement(ActionButton, {
        key: index,
        className: className,
        onClick: onClick,
        disabled: disabled
...
ActionBar_ActionBar.displayName = "ActionBar";
...
function syntaxhighlighter_objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = syntaxhighlighter_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }

function syntaxhighlighter_objectWithoutPropertiesLoose(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } return target; }
...
var syntaxhighlighter_SyntaxHighlighter = function SyntaxHighlighter(_ref10) {
  ...
  }, rest), highlightableCode)), copyable ? /*#__PURE__*/react_default.a.createElement(ActionBar_ActionBar, {
    actionItems: [{
